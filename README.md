...
- [Wesley's Log - Day 166](https://wesley.thesisko.com/posts/wesleys-log-day-166/) — A patrol-day reflection on fixing real friction, making maintenance scripts easier to use, and learning to take pride in boring done well.
